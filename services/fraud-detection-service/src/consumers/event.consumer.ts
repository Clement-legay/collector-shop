...
export class EventConsumer implements OnModuleInit, OnModuleDestroy {
    ...
    constructor(
        ...
        this.priceOrangeThreshold = this.configService.get<number>('PRICE_CHANGE_ORANGE_THRESHOLD', 5);
        this.priceRedThreshold = this.configService.get<number>('PRICE_CHANGE_RED_THRESHOLD', 10);
        this.purchaseOrangeThreshold = this.configService.get<number>('RAPID_PURCHASE_ORANGE_THRESHOLD', 5);
        this.purchaseRedThreshold = this.configService.get<number>('RAPID_PURCHASE_RED_THRESHOLD', 10);
        this.purchaseWindowMs = this.configService.get<number>('RAPID_PURCHASE_WINDOW_MINUTES', 10) * 60 * 1000;
    }
